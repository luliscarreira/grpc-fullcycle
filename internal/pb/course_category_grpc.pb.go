...
type CategoryServiceClient interface {
	...
	GetCategoryById(ctx context.Context, in *CategoryByIdRequest, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) GetCategoryById(ctx context.Context, in *CategoryByIdRequest, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	GetCategoryById(context.Context, *CategoryByIdRequest) (*Category, error)
...
func (UnimplementedCategoryServiceServer) GetCategoryById(context.Context, *CategoryByIdRequest) (*Category, error) {
...
func _CategoryService_GetCategoryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategoryById(ctx, req.(*CategoryByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
